...
| `tts_say` | 通过本地 TW-TTS 串口模块朗读文本 |
| `tts_control` | 停止、暂停、继续、查询状态，或调整 TW-TTS 音量/语调 |
...
- **本地语音** — 可接入 TW-TTS 串口语音模块，让 AI 朗读文本
...
- **[docs/WIRING.md](docs/WIRING.md)** — USB、SD 卡、TW-TTS、扩展 GPIO 的统一接线表
- **[docs/TW_TTS.md](docs/TW_TTS.md)** — TW-TTS 串口协议和调试方式
