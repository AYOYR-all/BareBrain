 ...
 * Input JSON: {"path": "<BRN_SPIFFS_BASE>/...", "old_string": "...", "new_string": "..."}
 */
 ...
 * Input JSON: {"prefix": "<BRN_SPIFFS_BASE>/..."} (prefix is optional)
 */
