...
static const char *TIME_SOURCE_HOST = "www.cloudflare.com";
static const char *TIME_SOURCE_URL = "https://www.cloudflare.com/";
...
/* Fetch time via proxy: HEAD request to a generic HTTPS endpoint, parse Date header */
static esp_err_t fetch_time_via_proxy(char *out, size_t out_size)
{
    proxy_conn_t *conn = proxy_conn_open(TIME_SOURCE_HOST, 443, 10000);
