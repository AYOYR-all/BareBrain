...
".hint{font-size:.85em;line-height:1.45;color:#666;margin-top:8px}"
...
"Use ClawApp on the same LAN for daily chat and control. This local portal stays at 192.168.4.1 for setup and later updates."
"</p>"
"<div class='card'>"
"<div class='card-body'>"
"<div class='hint'><strong>Primary path:</strong> connect MimiClaw to WiFi here, then open ClawApp and add the board's LAN IP.</div>"
...
"<div class='card-body'>"
"<div class='hint'>Only fill this section if you still want the board to chat through Feishu/Lark in addition to ClawApp.</div>"
"<label>App ID</label>"
...
"<div class='card-body'>"
"<div class='hint'>Use this only when MimiClaw should keep an outbound WebSocket connection to a public relay.</div>"
